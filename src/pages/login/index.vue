  ...
  <div class="container" :class="{'sign-up-mode':container}">
    <div class="form-warp">
      <form class="sign-in-form">
        ...
        <div @click="sign()" class="submit-btn">立即登录</div>
      </form>
    ...
    <div class="desc-warp">
      <div class="desc-warp-item sign-up-desc">
        <div class="content">
          <button @click="signUp()" id="sign-up-btn">注册</button>
        </div>
        <img src="../../assert/login/log.svg" alt="">
      </div>
      <div class="desc-warp-item sign-in-desc">
        <div class="content">
          <button @click="signIn()" id="sign-in-btn">登录</button>
        </div>
        <img src="../../assert/login/register.svg" alt="">
      </div>
    </div>
  </div>
</template>
